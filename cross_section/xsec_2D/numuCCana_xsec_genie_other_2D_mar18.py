...
outputdir = '/home/tmettler/Desktop/v08_00_00_33/V08_00_00_35/weighted_improved/'+'xsec_other_2D_mar18/' 
...
# # Other Genie cross section variation 2 unisims, 2D
...
RootFile = ROOT.TFile(output_filedir+"Other_Genie_2D.root","RECREATE");
...
for para in range(num_para):
    for uni in range(num_universes):
        ...
        for t_bin in range(len_theta):
            ...
            globale.overlay_out.Draw('TrackMomRange_mu'+'>>h_temp['+str(para)+']['+str(uni)+']['+str(t_bin)+']',weight_name+'*All_UBGenie['+str(uni)+']*('+cut+this_cut+'&& !numu_signal && !track_end_uncontained)','',max_entries)
