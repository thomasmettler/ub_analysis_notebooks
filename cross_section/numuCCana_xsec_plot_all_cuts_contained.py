...
outputdir = '/home/tmettler/Desktop/v08_00_00_33/V08_00_00_35/weighted/xsec_V25_contained/'
...
fidVol = '(Nu_Vx_sce>(-1.55+10) && Nu_Vx_sce<(254.8-10)) && (Nu_Vy_sce>(-115.53+10) && Nu_Vy_sce<(117.47-10)) &&(Nu_Vz_sce>(-0.1+10) && Nu_Vz_sce<(1036.9-50)) && nr_tracks_uncontained==0'
...
NuCC_w.make_stacked_histo_weightV2(cut,'TrackMomMCS_mom','EventWeight','Reco. muon track momentum (MCS) [GeV]',0,2.5,20,'TrackMom'+name,side_right)
NuCC_w.make_stacked_histo_weightV2(cut,'TrackMomRange_mu','EventWeight','Reco. muon track momentum (range) [GeV]',0,2.5,20,'TrackMomRange'+name,side_right)
...
NuCC_w.make_stacked_histo_weightV2(cut,'TrackLength','EventWeight','muon track length [cm]',0,600,50,'TrackLength'+name,'right')
...
NuCC_w.make_stacked_histo_weightV2(cut,'nr_crthit_top','EventWeight','Number of CRT hits in top',0,4,4,'nr_crthit_top'+name,'right')
...
NuCC_w.make_stacked_histo_weight_MCC8(cut,'TrackMomMCS_mom','EventWeight','Reco. muon track momentum (MCS) [GeV]',0,2.5,20,'TrackMom'+name,side_right)
NuCC_w.make_stacked_histo_weight_MCC8(cut,'TrackMomRange_mu','EventWeight','Reco. muon track momentum (range) [GeV]',0,2.5,20,'TrackMomRange'+name,side_right)

NuCC_w.make_stacked_histo_weight_MCC8(cut,'cos(TrackTheta)','EventWeight','Cos(theta)',-1,1,20,'cosTheta'+name,side_left)
NuCC_w.make_stacked_histo_weight_MCC8(cut,'TrackPhi','EventWeight','Reco. muon phi',-3.15,3.15,20,'phi'+name,side_left)

NuCC_w.make_stacked_histo_weight_MCC8(cut,'TrackLength','EventWeight','muon track length [cm]',0,600,50,'TrackLength'+name,'right')
NuCC_w.make_stacked_histo_weight_MCC8(cut,'TrackPID_chiproton','EventWeight','Track PID Chi2 proton',0,350,20,'PIDproton'+name,side_left)
NuCC_w.make_stacked_histo_weight_MCC8(cut,'TrackPID_chimuon','EventWeight','Track PID Chi2 muon',0,60,20,'PIDmuon'+name,'right')
NuCC_w.make_stacked_histo_weight_MCC8(cut,'TrackPID_chipion','EventWeight','Track PID Chi2 pion',0,60,20,'PIDpion'+name,'right')
NuCC_w.make_stacked_histo_weight_MCC8(cut+'&& TrackPID_chimuon!=-999','TrackPID_chimuon/TrackPID_chiproton','EventWeight','Track PID Chi2 muon/proton ration',0,0.25,20,'PIDmuprot_ration'+name,'right')
NuCC_w.make_stacked_histo_weight_MCC8(cut,'TrackPID_chimuon/TrackPID_chipion','EventWeight','Track PID Chi2 muon/pion ration',0.4,1.2,20,'PIDmupion_ration'+name,'right')
...
NuCC_w.make_stacked_histo_weight_MCC8(cut,'TrackScore','EventWeight','TrackScore',0.5,1,20,'TrackScore'+name,side_left)
