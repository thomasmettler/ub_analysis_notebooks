...
outputdir = '/home/tmettler/Desktop/v08_00_00_33/V08_00_00_35/weighted_improved/event_rates_thesis_tmp/'
...
NuCC.loadGlobal(data,ext,dirt,overlay,data_out,ext_out,dirt_out,overlay_out,scale,scale_out,tot_num_fidVol,overlay_signals,sample,sample_out, name,name_out, outputdir_png, outputdir_root,outputdir_pdf)
print 'All cuts'
#NuCC_w.make_stacked_histo_MCC8_pub_impMom(cut,'EventWeight','p_{#mu}^{reco} (MCS+range) [GeV/c]' ,0,1.5,20,'TrackMCSRange'+name,side_right)
...
#NuCC_w.make_stacked_histo_MCC8_pub_impMom(cut,'EventWeight','p_{#mu}^{reco} (MCS+range) [GeV/c]' ,0,1.5,20,'TrackMCSRange'+name,side_right)
#NuCC_w.make_stacked_histo_MCC8_pub(cut,'TrackMomMCS_mom','EventWeight','p_{#mu}^{reco} MCS [GeV/c]' ,0,1.5,20,'TrackMomMCS'+name,side_right)
#NuCC_w.make_stacked_histo_MCC8_pub(cut,'TrackMomRange_mu','EventWeight','p_{#mu}^{reco} range [GeV/c]' ,0,1.5,20,'TrackMomR'+name,side_right)
#NuCC_w.make_stacked_histo_MCC8_pub(cut,'cos(TrackTheta)','EventWeight','cos(#theta_{#mu}^{reco})',-1,1.001,20,'cosTheta'+name,side_left)
...
#NuCC_w.make_stacked_histo_MCC8_pub(cut,'nr_crthit_top','EventWeight','Number of CRT hits in top',-0.5,3.5,4,'CRTTophit'+name,'right')
#NuCC_w.make_stacked_histo_MCC8_pub(cut,'crthit_vertex_zcut','EventWeight','Number of CRT hits upstream of vertex',-0.5,3.5,4,'CRTVertexcut'+name,'right')
...
#NuCC_w.make_stacked_histo_MCC8_pub(cut,'TrackLength','EventWeight','Candidate Track Length [cm]',0,500,50,'TrackLength'+name,'right')

# In[ ]:



cut = 'fidVol && muon && nr_crthit_top==0'
name = '_020'
side_right = 'right'
side_left = 'left'
#folder = 'Quality_cut/'
...
#NuCC_w.make_stacked_histo_MCC8_pub(cut,'crthit_vertex_zcut','EventWeight','Number of CRT hits upstream of vertex',-0.5,3.5,4,'CRTVertexcut'+name,'right')
'''
cut = 'fidVol && muon && nr_crthit_top==0 && crthit_vertex_zcut==0'
name = '_021'
side_right = 'right'
side_left = 'left'
#folder = 'Quality_cut/'
...
cut = 'fidVol && muon && nr_crthit_top==0 && crthit_vertex_zcut==0 && (track_end_uncontained==1 || nr_crthit_beam_tres==0)'
name = '_022'
side_right = 'right'
side_left = 'left'
#folder = 'Quality_cut/'
...
cut = 'fidVol && muon && nr_crthit_top==0 && crthit_vertex_zcut==0 && (track_end_uncontained==1 || nr_crthit_beam_tres==0) && crt_cut'
name = '_023'
side_right = 'right'
side_left = 'left'
#folder = 'Quality_cut/'
...
#NuCC_w.make_stacked_histo_MCC8_pub_tmp(cut,'TrackScore','EventWeight','Track Score',0.5,1.001,20,'TrackScore'+name,side_left)
...
cut = 'fidVol && muon && crt_tom_cut && TrackScore>0.8 && TrackLength>20'
name = '_05'
side_right = 'right'
side_left = 'left'
...
cut = 'fidVol && muon && crt_tom_cut && TrackScore>0.8 && TrackLength>20 && TrackPID_chiproton>78'
name = '_06'
side_right = 'right'
side_left = 'left'
#folder = 'TrackPID_cut/'
...
NuCC_w.make_stacked_histo_weight_MCC8(cut,'cos(TrackTheta)','EventWeight','cos(#theta_{#mu}^{reco})',-1,1.001,20,'cosTheta'+name,side_left)
...
NuCC_w.make_stacked_histo_weight_MCC8(cut,'TrackScore','EventWeight','Track Score',0.5,1.001,20,'TrackScore'+name,side_left)
NuCC_w.make_stacked_histo_weight_MCC8(cut,'NuScore','EventWeight','Topological score',0,1.001,20,'NuScore'+name,'right')
