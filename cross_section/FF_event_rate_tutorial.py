...
inputdir = '/home/tmettler/Desktop/uBoone/Forwardfolding/tutorial/'
...
num_uni_override = 100
path_sys = inputdir+'plots_sys/'
...
def return_covar(h_true):
    ...
    num_bins = h_smearing_matrix.GetNbinsX()
    ...
    # for the storage of smeared true and background varied distributions
