...
def linear(x, y, b=1):
    ...
    result = np.dot (x , y.T) + b # Note the @ operator for matrix multiplication
    #pass
...
def own(x, y, sigma=1):    
    ...
    #pass
    result = (np.dot (x , y.T))*(np.dot (x , y.T)) # Note the @ operator for matrix multiplication
...
def decision_function(alphas, target, kernel, X_train, x_test, b):
    ...
    #######################################################################
    # TODO:                                                               #
    # Compute the decision function                       s                #
    #######################################################################
    
    #pass
    #result = (alphas * target) @ kernel(X_train, x_test) - b
    #print (alphas * target).shape
    #print kernel(X_train, x_test).shape
    #print b.shape
